...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnViewBilOrderPlacedDetails = new javax.swing.JButton();
        ...
        getContentPane().add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 6, -1, -1));

        btnPlaceOrder.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        btnPlaceOrder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/place order.png"))); // NOI18N
        btnPlaceOrder.setText("Place Order");
        getContentPane().add(btnPlaceOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(178, 6, -1, -1));

        btnViewBilOrderPlacedDetails.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        btnViewBilOrderPlacedDetails.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/View Bills & Order Placed Details.png"))); // NOI18N
        btnViewBilOrderPlacedDetails.setText("View Bil & Order Placed Details");
        getContentPane().add(btnViewBilOrderPlacedDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 6, -1, -1));
        ...
        getContentPane().add(btnChangePassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(712, 6, -1, -1));

        btnChangeSecurityQuestion.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnChangeSecurityQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(947, 6, -1, -1));
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1248, 6, -1, -1));

        btnManageCategory.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnManageCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 700, -1, -1));

        btnNewProduct.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnNewProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 700, -1, -1));

        btnViewEditDeleteProduct.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnViewEditDeleteProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 700, -1, -1));

        btnVerifyUsers.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnVerifyUsers, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 700, -1, -1));
    ...
    private javax.swing.JButton btnViewBilOrderPlacedDetails;
